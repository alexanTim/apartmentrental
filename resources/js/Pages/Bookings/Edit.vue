...
const props = defineProps({
  booking: Object, // The existing booking to edit
  rooms: Array,    // Available rooms
  tenants: Array   // Available tenants
})

// Create a useForm instance pre-filled with booking data
const form = useForm({
  tenant_id: props.booking.tenant.id,
  email: props.booking.tenant.email,
  tenant_phone: props.booking.tenant.phone,
  ...
  length_stay: props.booking.length_stay || '', // number of days or months
  stay_type: props.booking.rent_type || '', // 'transient' or 'monthly'
                              ...
                              <div>
                                ...
                                <div>
                                  <div v-if="form.stay_type && form.open_ended==false" class="mb-4">                                
                                      <label for="length_stay" class="block font-medium">
                                ...
                                <div>
                                  ...
                                  <input v-model="form.total_price" type="number" step="0.01" class="rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600 mt-1 block w-full" />
                                  <span v-if="form.errors.total_price" class="text-red-500 text-sm">{{ form.errors.total_price }}</span>
                                </div>
